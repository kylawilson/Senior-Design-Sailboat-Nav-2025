...
class VivaldiS1Service(Service):
    ...
    ESPRESSO_SVC_UUID = "ec2ce16f-f774-4c1f-b3dd-a56b64bc9037"
...
class PowerControlCharacteristic(Characteristic):
    ...
    def __init__(self, bus, index, service):
        Characteristic.__init__(
            self, bus, index, self.uuid, ["encrypt-read", "encrypt-write", "notify"], service,
        )
...
class AutoOffCharacteristic(Characteristic):
    ...
    def __init__(self, bus, index, service):
        Characteristic.__init__(
            self, bus, index, self.uuid, ["secure-read", "secure-write", "notify"], service,
        )
